...
const MoreAbout = () => {
  return (
    <div className="md:mt-16">
      <h2 className="text-3xl font-semibold leading-10 tracking-tight text-black-600 sm:text-3xl sm:leading-none md:text-4xl">
        More About Projects
      </h2>
      ...
      <div className="flex justify-center space-x-5 md:mt-5">
        <div className="w-1/3 border border-primary flex flex-col items-center md:p-5 md:rounded-xl md:shadow-xl">
          <img src={Pool} alt="Pool" className="mb-2" />
          <p className="text-center md:mt-5 md:text-2xl md:text-primary">Pool</p>
        </div>
        <div className="w-1/3 border border-primary flex flex-col items-center md:p-5 md:rounded-xl md:shadow-xl">
          <img src={Vacations} alt="Vacations" className="mb-2" />
          <p className="text-center md:mt-5 md:text-2xl md:text-primary">Vacations</p>
        </div>
        <div className="w-1/3 border border-primary flex flex-col items-center md:p-5 md:rounded-xl md:shadow-xl">
          <img src={Mask} alt="Mask" className="mb-2" />
          <p className="text-center md:mt-5 md:text-2xl md:text-primary">Mask</p>
        </div>
      </div>
    </div>
  );
